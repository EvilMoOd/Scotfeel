...
export interface Comment {
  momentId: number;
  content: string;
  commentedUserInfo: ErInfo[];
  commentedUserRemark: CommenteerRemark[];
  commenterInfo: ErInfo[];
  commenterRemark: CommenteerRemark[];
  commentType: number;
  createTime: number;
}

export interface ErInfo {
  _id: string;
  nickname: string;
  avatar: string;
}

export interface CommenteerRemark {
  remarkName: string;
}
