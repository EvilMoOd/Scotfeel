...
//插入数据
async function insert(sessionId , userId ,	content	, contentType , createTime , belongToId){
...
async function selectSingleChat(lastId,sessionId,belongToId){
...
async function selectGroupChat(lastId,sessionId,belongToId){
	return await baseSql.selectSql(`
...
export default {createTable,insert,selectSingleChat,selectGroupChat};