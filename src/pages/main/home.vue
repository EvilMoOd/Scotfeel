				...
				<view class="chat1" @tap="goChat">
					...
					<view class="chat-place">
						<view
							...
							><text class="time">18:22</text></view
						>
	...
	<transition name="menu">
		<view class="menu" v-show="isShow">
			<view class="person-top">
				<view class="person-place" @tap="goPerson"
					...
					<view class="person-msg"
						...
						><view class="idCard">@pdd</view></view
					>
			...
			<view class="function-place">
				<view class="function">
					<view class="fuc"
						><uni-icons type="scan" size="25"></uni-icons>扫一扫</view
					>
					<view class="fuc" @tap="goMailList"
						><uni-icons type="contact" size="25"></uni-icons> 通讯录</view
					>
					<view class="fuc" @tap="goAddFriends"
						><uni-icons type="personadd" size="25"></uni-icons> 添加好友</view
					>
					<view class="fuc" @tap="goCreateGroupChat"
						><uni-icons type="staff" size="25"></uni-icons> 创建群聊</view
					>
					<view class="fuc" @tap="goCreateSpace"
						><uni-icons type="home" size="25"></uni-icons> 创建空间</view
					>
				</view>
				<view class="setup" @tap="goSetting"
					><uni-icons type="gear" size="25"></uni-icons>设置与隐私
				</view>
			</view>
			<!-- 退出登录 -->
